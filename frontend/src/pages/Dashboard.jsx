...
const map = {}
items.forEach(it => { map[it.category] = (map[it.category] || 0) + 1 })
...
<StatCard title="In Stock" value={items.filter(i=>i.stock>0).length} />
<StatCard title="Low Stock" value={items.filter(i=>i.stock>0 && i.stock<5).length} />
</div>
